import { Box, ColumnConfig, Spinner, Text } from "grommet";
...
import {
	Address,
	DateTime,
	formatNumber, PaginationNavigator,
	PaginationRecordsPerPage
} from "src/components/ui";
import { Filter, RPCTransactionAstra } from "src/types";
...
function getColumns(props: any) {
	...
	return [
		...
		},
		{
			...
			render: (data: RPCTransactionAstra) => <Address address={data.from} />,
		},
		{
			property: "to",
			size: "large",
			...
			render: (data: RPCTransactionAstra) => <Address address={data.to} />,
		},
		{
			property: "value",
			size: "380px",
