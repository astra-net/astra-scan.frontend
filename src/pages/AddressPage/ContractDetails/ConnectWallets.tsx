				...
				validChainId ? (
					...
					<Box direction={"column"}>
						<Text size="small" color="errorText">
							...
							network to Astra {isMainNet ? "Mainnet" : "Testnet"}
						</Text>
						<ActionButton
							style={{ width: "250px" }}
							margin={{ top: "small" }}
							onClick={() =>
								window.open(
									"https://docs.astranetwork.com/home/network/wallets/browser-extensions-wallets/metamask-wallet",
									"_blank"
								)
							}
						>
							Readme Astra Metamask setup
						</ActionButton>
					</Box>
				)
			) : (
