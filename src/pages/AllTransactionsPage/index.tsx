...
import { getCount, getTransactions } from "src/api/client";
...
import { Filter, RPCTransactionAstra } from "../../types";
...
export function AllTransactionsPage() {
	...
	const [trxs, setTrxs] = useState<RPCTransactionAstra[]>([]);
	...
	useEffect(() => {
		const getElements = async () => {
			try {
				...
				setTrxs(trxs as RPCTransactionAstra[]);
			} catch (err) {
				console.log(err);
			}
		};
