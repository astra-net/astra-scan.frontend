					...
					<Box margin={{ left: "10px", top: "medium" }}>
						...
						{metamaskAddress?.length > 0 && (
							<Box>
								...
								>
									<Tab title={<Text size="small">HRC20</Text>}></Tab>

									<Tab title={<Text size="small">HRC1155</Text>}></Tab>

									<Tab title={<Text size="small">HRC721</Text>}></Tab>
								</Tabs>
